...
기존 도로 459개와 10개 코스의 연결을 유지하고 도시 도로 124개를 더해 총 583개다. 넓은 도로에 맞춰 급커브 반경, 연결부,
...
41개 블록에 새 건물 164개, 한국 도심 3–6m / 업무 지구 8–16m 높이 변형,
상가 간판·창문·발코니·옥상 설비와 포디움/상층부 변형을 배치했다. 건물 대지의
점유율은 각 블록 65–80%다. 도시 지면은 콘크리트 포장이며 잔디 면적은 0%다.
