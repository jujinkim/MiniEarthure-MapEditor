...
func start(source: String, license_name: String, accuracy: String, python: String, token: String, coordinates: Dictionary = {"mode":"local-metres"}, input_format: String = "geojson", source_label: String = "") -> String:
	...
	if input_format not in ["geojson", "pbf", "osm", "overture", "overture-transportation"]: return "Unsupported source format."
	...
	var files := FILES.new()
	for module in ["geojson.py", "polygon_geometry.py", "import_layer.py", "projection.py", "osm_extract.py", "osm_area.py", "overture_area.py", "overture_transportation.py"]:
...
func cleanup() -> void:
	...
	for name in ["geojson.py", "polygon_geometry.py", "import_layer.py", "projection.py", "osm_extract.py", "osm_area.py", "overture_area.py", "overture_transportation.py", "osm_download.py", "copernicus_dem.py", "dem.png.part", "request.json", "download.part", "layer.json"]:
